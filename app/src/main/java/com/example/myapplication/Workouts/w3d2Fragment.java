 ...
 * {@link w3d2Fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link w3d2Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class w3d2Fragment extends Fragment {
    ...
    public static w3d2Fragment newInstance(Parcelable param1) {
        w3d2Fragment fragment = new w3d2Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        plankTimer = new CountDownTimer(140000, 1000) {
    ...
    public void jumpingJacks() {
        ...
        if (sf.getBoolean("ex1", false)) {
            ...
            timerCount.setText(R.string.reps_w3d2);
            String text = getResources().getString(R.string.voice_coach_jumping_jacks_w3d2);
            if (sf.getBoolean("ttsKey", true))
                WorkoutActivity.ttsManager.initQueue(text);
        }

        isDoneJumpingJacks = true;
        jumpingJacksCount = getResources().getString(R.string.reps_w3d2);
    }
    ...
    public void planks() {
        ...
        if (sf.getBoolean("ex2", false)) {
            ...
            String text = getResources().getString(R.string.voice_coach_plank_w3d2);
            if (sf.getBoolean("ttsKey", true))
                WorkoutActivity.ttsManager.initQueue(text);
        ...
        isDonePlank = true;
        plankCount = getResources().getString(R.string.plank_count_w3d2);
    }
    ...
    public void lunges() {
        ...
        if(sf.getBoolean("ex3", false)) {
            ...
            timerCount.setText(R.string.reps_w3d2);
            String text = getResources().getString(R.string.voice_coach_lunge_w3d2);
            if (sf.getBoolean("ttsKey", true))
                WorkoutActivity.ttsManager.initQueue(text);
        }

        isDoneLunges = true;
        lungesCount = getResources().getString(R.string.reps_w3d2);
    }
    ...
    public void pushups() {
        ...
        if(sf.getBoolean("ex4", false)) {
            ...
            timerCount.setText(R.string.reps_w3d2);
            String text = getResources().getString(R.string.voice_coach_pushup_w3d2);
            if (sf.getBoolean("ttsKey", true))
                WorkoutActivity.ttsManager.initQueue(text);
        }

        isDonePushups = true;
        pushupsCount = getResources().getString(R.string.reps_w3d2);
    }
    ...
    public void situps() {
        ...
        if(sf.getBoolean("ex5", false)) {
            ...
            timerCount.setText(R.string.reps_w3d2);
            String text = getResources().getString(R.string.voice_coach_situp_w3d2);
            if (sf.getBoolean("ttsKey", true))
                WorkoutActivity.ttsManager.initQueue(text);
        }

        isDoneSitups = true;
        situpsCount = getResources().getString(R.string.reps_w3d2);
    }
    ...
    public void highKnees() {
        ...
        if(sf.getBoolean("ex6", false)) {
            ...
            timerCount.setText(R.string.reps_w3d2);
            String text = getResources().getString(R.string.voice_coach_high_knees_w3d2);
            if (sf.getBoolean("ttsKey", true))
                WorkoutActivity.ttsManager.initQueue(text);
        }

        isDoneHighKnees = true;
        highKneesCount = getResources().getString(R.string.reps_w3d2);
    }
    ...
    public void sideplank() {
        ...
        if(sf.getBoolean("ex7", false)) {
            ...
            timerCount.setText(R.string.reps_w3d2);
            String text = getResources().getString(R.string.voice_coach_side_plank_w3d2);
            if (sf.getBoolean("ttsKey", true))
                WorkoutActivity.ttsManager.initQueue(text);
        }

        isDoneSidePlank = true;
        sidePlankCount = getResources().getString(R.string.reps_w3d2);
    }
    ...
    public void tricepDip() {
        ...
        if(sf.getBoolean("ex8", false)) {
            ...
            timerCount.setText(R.string.reps_w3d2);
            String text = getResources().getString(R.string.voice_coach_tricep_dip_w3d2);
            if (sf.getBoolean("ttsKey", true))
                WorkoutActivity.ttsManager.initQueue(text);
        }

        isDoneTricepDips = true;
        tricepDipCount = getResources().getString(R.string.reps_w3d2);
    }
    ...
    public void squats() {
        ...
        if(sf.getBoolean("ex9", false)) {
            ...
            timerCount.setText(R.string.reps_w3d2);
            String text = getResources().getString(R.string.voice_coach_squats_w3d2);
            if (sf.getBoolean("ttsKey", true))
                WorkoutActivity.ttsManager.initQueue(text);
        }

        isDoneSquats = true;
        squatCount = getResources().getString(R.string.reps_w3d2);
    }
